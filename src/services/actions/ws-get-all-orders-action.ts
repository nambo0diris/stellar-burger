...
export const getAllOrdersSuccess = (event: Event): IGetAllOrdersSuccess => ({
    type: WS_CONNECTION__ALL_ORDERS_SUCCESS,
    payload: event,
})

export const getAllOrdersError = (event: Event): IGetAllOrdersError => ({
    type: WS_CONNECTION__ALL_ORDERS_ERROR,
    payload: event
})

export const getAllOrdersDisconnect = (event: Event): IGetAllOrdersDisconnect => ({
